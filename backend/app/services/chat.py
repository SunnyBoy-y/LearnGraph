            ...
            messages.append(
                ProviderChatMessage(
                    ...
                    content=(
                        ...
                        "downloadable single files to sandbox_publish_file - pass only the "
                        "path and do not try to read binary files first (sandbox_read_file "
                        "only serves UTF-8 text); PPTX/ZIP/PDF and other binary deliverables "
                        "are fully supported by sandbox_publish_file - and explain "
